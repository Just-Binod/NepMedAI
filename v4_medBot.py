    ...
    with st.chat_message("assistant"):
        with st.spinner("Searching knowledge base..."):
            try:
                ...
                print(f"[NepMedAI ERROR] {error_str}")
                if "429" in error_str or "RESOURCE_EXHAUSTED" in error_str or "quota" in error_str.lower():
                    answer = "माफ गर्नुहोस्, आजको AI अनुरोध सीमा समाप्त भयो। भोलि फेरि प्रयास गर्नुहोस्।\n\nSorry, the daily request limit has been reached. Please try again tomorrow."
                elif "503" in error_str or "UNAVAILABLE" in error_str or "high demand" in error_str:
                    answer = "AI सेवामा अहिले धेरै व्यस्तता छ। केही क्षण पर्खनुहोस् र फेरि प्रयास गर्नुहोस्।\n\nThe service is busy right now. Please wait a moment and try again."
                elif "timeout" in error_str.lower():
                    answer = "जवाफ आउन ढिला भयो। कृपया फेरि प्रयास गर्नुहोस्।\n\nThe request timed out. Please try again."
                elif "API_KEY" in error_str or "api key" in error_str.lower() or "credential" in error_str.lower():
                    answer = "API key सेटअप गर्न समस्या भयो। कृपया .env फाइल जाँच गर्नुहोस्।\n\nAPI key setup issue. Please check your .env file."
                elif "not found" in error_str.lower() or "model" in error_str.lower():
                    answer = "AI मोडेल लोड हुन समस्या भयो। कृपया फेरि प्रयास गर्नुहोस्।\n\nAI model could not be loaded. Please try again."
                else:
                    answer = "केही समस्या आयो। कृपया फेरि प्रयास गर्नुहोस्।\n\nSomething went wrong. Please try again."
                sources = []
